                ...
                <div class="flex items-center space-x-1 mr-5">
                    ...
                    @auth
                        @if(auth()->user()->role === 'student')
                            ...
                            <!-- Chat Link -->
                            <a href="{{ route('web.chats') }}" class="nav-link nav-link-chat text-white relative" style="font-family: 'Inria Sans', sans-serif; font-weight: 300; text-shadow: -2px 2px 4px #000000;">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
